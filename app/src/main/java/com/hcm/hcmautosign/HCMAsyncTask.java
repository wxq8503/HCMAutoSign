...
/**
 * Created by weia on 2018/1/24.
 */

public abstract class HCMAsyncTask extends AsyncTask<String,String,ArrayList> {
    //Alan
    ...
    protected ArrayList doInBackground(String... params) {
        try {
            ...
            if(params[0].equals("PunCheck")) {
                ...
                return HCM_PunCheck_OKHttp(authorization, longitude, latitude);
            }
        } catch (Exception e){
    ...
    public ArrayList HCM_PunCheck_OKHttp(String authorization, String longitude, String latitude){
    ...
    public ArrayList HCM_GeoCheck_OKHttp(String authorization, String longitude_str, String latitude_str){
    /*public ArrayList HCM_GeoCheck_OKHttp(){
        String authorization = preferences.getString("KEY_AUTH_CODE", "N/A");
...
*/
    ...
    public ArrayList HCM_Punchin_OKHttp(String authorization, String longitude, String latitude){
    //public ArrayList HCM_Punchin_OKHttp(){
        /*
        String authorization = preferences.getString("KEY_AUTH_CODE", "N/A");
        String longitude;
